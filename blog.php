            ...
            <div class="banner d-flex align-items-center">
                <div class="content-wrapper top-zero ">
                    ...
                    <div class="basic-intro text-center">
                        ...
                        <h2 class="title white"><span class="text-2 text-style-8 blog-subtitle banner-subtitle"></span>
                        </h2>
                    </div>
                </div>
                <!-- Image -->
                <div class="image-wrapper">
                    ...
                    <img src="" class="image banner-fixed fit-cover brightness-8" alt="Banner blog."
                        style="background-color: #18355e;" />
        ...
        <section class="shock-section blog-section mt-4 mb-4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="shock-section container" id="blog-container" data-aos="fade-up" data-aos-delay="200"
                            data-aos-duration="800">
                            <!-- Posts se cargarán aquí -->
                        </div>
                        <div class="items-container" style="display: flex; ">
                            <a href="<?php echo $idioma; ?>/blog_all"
                                class=" button-transparent button-orange text-center"
                                style=""><strong><?php echo TITULOS_BLOG[3]; ?></strong></a>
                            ...
                            <div class="container mt-3 d-flex justify-content-center pagination-items">
                                <div class="row">
                                    <div id="prev-page" class="col-4 col-md-3 col-lg-6">
                                        <svg class="swiper-button-prev" src="assets/icons/icon_arrows_blue_left.svg"
                                            alt="Prev" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            width="1rem" height="1rem" viewBox="0 0 231.26 729.5">
                                            <path class="cls-1"
                                    ...
                                    <div id="next-page" class="col-4 col-md-3 col-lg-6">
                                        ...
                                        <svg class="swiper-button-next" src="assets/icons/icon_arrows_blue_right.svg"
                                            alt="Prev" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            width="1rem" height="1rem" viewBox="0 0 231.26 729.5">
                                            <path class="cls-1"
                    ...
                    <div class="title-image">
                        ...
                        <div class="slide-share position-absolute top-0 end-0 p-1 button-share">
                            <div class="container-btn">
                                <div class="redes">
                                    <a target="_self" class="bg-orange" aria-label="Compartir en Facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $path; ?>es/blog/${data.title}">
                                        <i class="icon fab fa-facebook-f"></i>
                                    </a>
                                    <a target="_self" class="bg-orange" aria-label="Compartir en Twitter" href="https://twitter.com/intent/tweet?url=<?php echo $path; ?>es/blog/${data.title}">
                                    ...
                                    <a target="_self" class="bg-orange" aria-label="Compartir en WhatsApp" href="https://api.whatsapp.com/send?text=<?php echo $path; ?>es/blog/${data.title}">
