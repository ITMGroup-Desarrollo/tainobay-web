                    ...
                    <div class="title-image">
                        ...
                        <div class="slide-share position-absolute top-0 end-0 p-1 button-share">
                            <div class="container-btn">
                                <div class="redes">
                                    <a target="_blank" class="bg-orange" href="https://www.facebook.com/sharer/sharer.php?u=https://localhost/tainobay/es/blog/${data.title}">
                                        <i class="icon fab fa-facebook-f"></i>
                                    </a>
                                    <a target="_blank" class="bg-orange" href="https://twitter.com/intent/tweet?url=https://localhost/tainobay/es/blog/${data.title}">
                                    ...
                                    <a target="_blank" class="bg-orange" href="https://api.whatsapp.com/send?text=https://localhost/tainobay/es/blog/${data.title}">
