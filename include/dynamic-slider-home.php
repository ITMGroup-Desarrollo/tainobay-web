                ...
                <div class="slide-item side-intro <?= $point['id'] == '1' ? 'current-slide' : '' ?>">
                    ...
                    <div class="slide-share position-absolute share p-1 button-share" style="z-index: 99;">
                        <div class="container-btn">
                            <div class="redes">
                                <a target="_self" class="bg-orange" href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>"><i class="icon fab fa-facebook-f"></i></a>
                                <a target="_self" class="bg-orange" href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
                                ...
                                <a target="_self" class="bg-orange" href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
