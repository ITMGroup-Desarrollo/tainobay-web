<section id="home" class="shock-section dynamic-slider scheme-1" data-autoplay="6000" data-aos="fade-up"
    ...
    <div class="static-content bg-orange">
        <h2 class="text-uppercase text-center text-style-3 text-white static-title">
            <strong><?= CAROUSEL_PORT_EXPERIENCE[0]; ?></strong>
        </h2>
        <!-- Controls carousel -->
        ...
        <nav
            ...
            <div class="flex-grow-1 d-none d-md-block">
                <p class="text-style-6 text-white"><span
                        class="d-block text-center text-md-start"><?= CAROUSEL_PORT_EXPERIENCE[1]; ?></span>
                    <span class="text-md-end text-center ml-4 d-block"><?= CAROUSEL_PORT_EXPERIENCE[2]; ?></span>
                </p>
            </div>
            <div class="flex-grow-1 d-md-none">
                <p class="text-style-6 text-white"><span
                        class="d-block text-center text-md-start"><?= CAROUSEL_PORT_EXPERIENCE[3]; ?></span></p>
            </div>
            <!-- Arrow Right -->
        ...
        <div class="slide-item side-intro <?= $point['id'] == '1' ? 'current-slide' : '' ?>">
            ...
            <div class="slide-share position-absolute share p-1 button-share" style="z-index: 99;">
                <div class="container-btn">
                    <div class="redes">
                        <a target="_self" class="bg-orange"
                            href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>"><i
                                class="icon fab fa-facebook-f"></i></a>
                        <a target="_self" class="bg-orange"
                            href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
                        ...
                        <a target="_self" class="bg-orange"
                            href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
            ...
            <div class="slide-button static-button d-none d-lg-block" style="z-index: 9;">
                <div class="container-button text-center">
                    <a href="<?= $idioma . '/port-experience/' . $point['path'] ?>"
                        class="text-uppercase button-transparent button-blue text-center button-carousel"><strong><?= CAROUSEL_PORT_EXPERIENCE[4] ?></strong></a>
                </div>
            </div>
            <!-- Intro -->
            <div class="slide-content"
                style="<?= $point['id'] == '1' ? 'background: linear-gradient(to bottom, rgba(255, 0, 0, 0), var(--blue-color));' : '' ?>">
                <span
                    class="slide-title text-1 text-style-1 text-white"><?= $point['id'] > 9 ? $point['id'] : '0' . $point['id']; ?></span>
