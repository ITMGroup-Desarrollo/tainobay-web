                    ...
                    <div class="slide-share position-absolute share p-1 button-share">
                        <div class="container-btn">
                            <div class="redes">
                                ...
                                <a target="_blank" class="bg-orange" href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
                                ...
                                <a target="_blank" class="bg-orange" href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $idioma; ?>/port-experience/<?= $point['path'] ?>">
