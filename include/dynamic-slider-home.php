                ...
                <div class="slide-item side-intro <?= $point['id'] == '1' ? 'current-slide' : '' ?>">
                    ...
                    <div class="slide-share position-absolute share p-1 button-share">
                        <div class="container-btn">
                            <div class="redes">
                                <a target="_blank" class="bg-orange" href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/<?= $point['name'] ?>"><i class="icon fab fa-facebook-f"></i></a>
                                ...
                                <a target="_blank" class="bg-orange" href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $point['name'] ?>">
