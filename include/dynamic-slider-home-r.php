            ...
            <div class="slide-item side-intro current-slide">
                ...
                <div class="slide-share position-absolute p-1 share-r button-share" style="z-index: 99;">
                    <div class="container-btn">
                        <div class="redes">
                            <a target="_blank" class="bg-blue" href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/en/discover-beyond"><i class="icon fab fa-facebook-f"></i></a>
                            <a target="_blank" class="bg-blue" href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/en/discover-beyond">
                            ...
                            <a target="_blank" class="bg-blue" href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/en/discover-beyond">
                ...
                <div class="slide-button static-button" style="z-index: 9;">
                    <div class="container-button text-center">
                        <a href="en/discover-beyond" class="text-uppercase button-transparent button-orange text-center button-carousel"><strong>Tour</strong></a>
                    </div>
                </div>
                <!-- Intro -->
                <div class="slide-content" style="background: linear-gradient(to bottom, rgba(255, 0, 0, 0), var(--blue-color));">
                    <span class="slide-title text-1 text-style-1 text-white">01</span>
                    <div class="slide-description">
                        <span class="text-style-4 text-white">Tour 1</span>
                    ...
                    <div class="slide-button button-mobile static-button d-md-none" style="z-index: 9;">
                        <div class="container-button text-center">
                            <a id="button-carrusel" href="en/discover-beyond" class="text-uppercase button-transparent button-orange text-center button-carousel">
