                ...
                <div class="slide-item side-intro <?= $tour['id'] == '1' ? 'current-slide' : '' ?>">
                    ...
                    <div class="slide-share position-absolute p-1 share-r button-share" style="z-index: 99;">
                        <div class="container-btn">
                            <div class="redes">
                                <a target="_self" class="bg-blue" href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond"><i class="icon fab fa-facebook-f"></i></a>
                                <a target="_self" class="bg-blue" href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond">
                                ...
                                <a target="_self" class="bg-blue" href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond">
