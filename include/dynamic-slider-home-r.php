...
<section id="home-r" class="shock-section dynamic-slider-r scheme-1" data-autoplay="6000" data-aos="fade-up"
    ...
    <div class="static-content bg-blue">
        <h2 class="text-uppercase text-center text-style-3 text-white">
            <strong><?= CAROUSEL_DISCOVER_BEYOND[0]; ?></strong>
        </h2>
        <!-- Controls carousel -->
        <nav
            class="slide-navigation d-flex align-items-md-center gap-md-3 w-100 w-md-75 max-w-2xl-60 wrapper-arrows static-arrows">
            <!-- Arrow Left -->
            <a href="#" class="slide-navigation-item-prev d-flex align-items-center text-orange" role="button"
                aria-label="Anterior">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="100" height="100"
                    viewBox="0 0 231.26 729.5">
                    <path class="cls-1"
                    ...
                    <path class="cls-1"
                        d="M224.12,729.5c.78,0,1.57-.13,2.34-.4,3.73-1.29,5.7-5.36,4.41-9.08l-118.63-342.14L230.91,9.33c1.21-3.75-.86-7.78-4.61-8.98-3.77-1.22-7.78.85-8.98,4.61l-120.14,373.1,120.19,346.65c1.02,2.95,3.79,4.8,6.74,4.8Z" />
                </svg>
            </a>
            <!-- Text Carousel -->
            <div class="flex-grow-1 d-none d-md-block">
                <p class="text-style-6 text-white"><span class="d-block text-center text-md-start"><?= CAROUSEL_DISCOVER_BEYOND[1];
                ; ?></span>
                    <span class="text-md-end text-center ml-4 d-block"><?= CAROUSEL_DISCOVER_BEYOND[2]; ?></span>
                </p>
            </div>
            <div class="flex-grow-1 d-md-none">
                <p class="text-style-6 text-white"><span class="d-block text-center text-md-start"><?= CAROUSEL_DISCOVER_BEYOND[3];
                ; ?></span></p>
            </div>
            <!-- Arrow Right -->
            <a href="#" class="slide-navigation-item-next d-flex align-items-center text-orange" role="button"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="100" height="100"
                    ...
                    <path class="cls-1"
                        d="M7.14,729.5c-.78,0-1.57-.13-2.34-.4-3.73-1.29-5.7-5.36-4.41-9.08l118.63-342.14L.35,9.33C-.86,5.58,1.2,1.56,4.95.35c3.77-1.22,7.78.85,8.98,4.61l120.14,373.1L13.88,724.7c-1.02,2.95-3.79,4.8-6.74,4.8Z" />
                </svg>
            </a>
        </nav>
    </div>
        ...
        <div class="slide-item side-intro <?= $tour['id'] == '1' ? 'current-slide' : '' ?>">
            ...
            <div class="slide-share position-absolute p-1 share-r button-share" style="z-index: 99;">
                <div class="container-btn">
                    <div class="redes">
                        <a target="_self" class="bg-blue"
                            href="https://www.facebook.com/sharer/sharer.php?u=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond"><i
                                class="icon fab fa-facebook-f"></i></a>
                        <a target="_self" class="bg-blue"
                            href="https://twitter.com/intent/tweet?url=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond">
                        ...
                        <a target="_self" class="bg-blue"
                            href="https://api.whatsapp.com/send?text=https://www.porttainobay.com/<?= $idioma; ?>/discover-beyond">
                    ...
                    <button class="border-0 text-white bg-transparent toggle-share" aria-label="Compartir">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 1024 1024">
                            <path fill="currentColor"
                                d="m679.872 348.8l-301.76 188.608a127.8 127.8 0 0 1 5.12 52.16l279.936 104.96a128 128 0 1 1-22.464 59.904l-279.872-104.96a128 128 0 1 1-16.64-166.272l301.696-188.608a128 128 0 1 1 33.92 54.272z" />
                        </svg>
                    </button>
                </div>
            </div>
            ...
            <div class="slide-button static-button" style="z-index: 9;">
                <div class="container-button text-center">
                    <a href="<?= $idioma ?>/discover-beyond"
                        class="text-uppercase button-transparent button-orange text-center button-carousel"><strong><?= CAROUSEL_DISCOVER_BEYOND[4] ?></strong></a>
                </div>
            </div>
            <!-- Intro -->
            <div class="slide-content"
                style="<?= $tour['id'] == '1' ? 'background: linear-gradient(to bottom, rgba(255, 0, 0, 0), var(--blue-color));' : '' ?>">
                <span
                    class="slide-title text-1 text-style-1 text-white"><?= $tour['id'] > 9 ? $tour['id'] : '0' . $tour['id']; ?></span>
                ...
                <div class="slide-button button-mobile static-button d-md-none" style="z-index: 9;">
                    <div class="container-button text-center">
                        <a id="button-carrusel" href="<?= $idioma ?>/discover-beyond"
                            class="text-uppercase button-transparent button-orange text-center button-carousel">
            ...
            <div class="slide-image-wrapper">
                <div class="slide-image-inner">
                    <div class="gallery swiper slider has-navigation has-pagination scheme-1 primary" data-columns="1,1,1,1"
