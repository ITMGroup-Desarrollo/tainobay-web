                                ...
                                <li class="nav-item">
                                    <div class="item">
                                        ...
                                        <div class="item-social">
                                            <a href="https://www.facebook.com//tainobayport/" class="link black black-hover" target="_self"><i class="icon fab fa-facebook-f" style="color: white; font-size:2rem"></i></a>
                                            <a href="https://www.instagram.com/tainobayport/" class="link black black-hover" target="_self"><i class="icon fab fa-instagram" style="color: white; font-size:2rem;"></i></a>
                                            <a href="https://www.tripadvisor.com.mx/Attraction_Review-g147290-d23803203-Reviews-Taino_Bay_Puerto_Plata-Puerto_Plata_Puerto_Plata_Province_Dominican_Republic.html" class="link black black-hover" target="_self"><img src="assets/images/icons/tripadvisor-blanco.png" width="30" height="30" alt="Icono Tripadvisor"></a>
