...
define('TITULOS_BANNER_FAQS', array(
    "FAQ's",
    'Any question for your next vacation at our cruise port? We got you!',
));

define('TITULOS_FAQS', array(
    'Frequently asked questions',
    'Here are some common questions about Taino Bay:'
));

define('TITLE_FORM', 'Still need help, ask a different questions?');
...
$faqs = [
    [
        'title' => 'Where is Taino Bay located?',
        'answer' => 'Taino Bay is in the beautiful Puerto Plata, the third largest city in the Dominican Republic.'
    ],
    [
        'title' => 'Is Puerto Plata close to Santo Domingo?',
        'answer' => 'We are located about 5 hours away from our capital.'
    ],
    [
        'title' => 'I didn’t book an experience and I’m arriving soon, can I book something at the port?',
        'answer' => 'We know planning a trip can get a bit complicated, but don’t worry! You can check the experiences upon arrival.'
    ],
    [
        'title' => 'Are there any tour recommendations for guests in wheelchairs?',
    ...
    [
        'title' => 'What can I find in Taino Bay?',
        'answer' => 'Taino Bay is a cruise port with activities for the whole family. Restaurants, clothing and souvenir stores, swimming pools, and incredible experiences.'
    ],
    [
        'title' => 'I don’t want to take a tour outside the port, is there something I can enjoy there?',
        'answer' => 'Yes! Our Monkey Island experience is at the port! It is perfect for guests of all ages.'
    ],
    [
        'title' => 'Are there free experiences at the port?',
        'answer' => 'Of course! You can relax at our pools and the lazy river. There is also a hammock area so you can take a power nap.'
    ],
    [
        'title' => 'Is there a beach in Taino Bay?',
        'answer' => 'In Taino Bay, you will find pools to relax in whenever you want. However, if you wish to enjoy the amazing Playa Dorada, you can ask for our exclusive experience. For more information, please visit our Last-Minute Booth upon arrival.'
    ],
    [
        'title' => 'Can I visit Taino Bay even if I´m not traveling by cruise?',
        'answer' => 'We are happy to know you wish to visit us! Currently, Taino Bay is not open to the general public. We will let you know if we have activities so you can come and visit us.'
    ],
    [
        'title' => 'Can I visit Taino Bay if I’m arriving at another port?',
        'answer' => 'Thank you so much for showing interest in Taino Bay. At the moment Taino Bay is exclusive to cruisers that are arriving here.'
    ],
    [
        'title' => 'I’m arriving soon but I don’t see the calendar for next months on the website',
        'answer' => 'We can’t wait to see you! Don’t worry. We keep them updated according to the current month.'
    ]
];
