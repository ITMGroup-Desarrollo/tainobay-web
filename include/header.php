    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-on-scroll absolute">
        <div class="container-fluid">
            ...
            <div id="menu-fixed" class="w-80 justify-content-evenly">
                <a href="<?php echo $path; ?><?php echo $idioma; ?>/port-experience"
                    class="menu-main-item-fixed"><?php echo MENU[8]; ?></a>
                <a href="<?php echo $path; ?><?php echo $idioma; ?>/discover-beyond"
                    class="menu-main-item-fixed"><?php echo MENU[9]; ?></a>
                <a href="<?php echo $path; ?><?php echo $idioma; ?>/map"
                    class="menu-main-item-fixed"><?php echo MENU[3]; ?></a>

                <a href="<?php echo $path; ?><?php echo $idioma; ?>/blog_all"
                    class="menu-main-item-fixed"><?php echo MENU[5]; ?></a>
                <a href="<?php echo $path; ?><?php echo $idioma; ?>/faqs"
                    class="menu-main-item-fixed"><?php echo MENU[6]; ?></a>
                <a href="<?php echo $path; ?><?php echo $idioma; ?>/contact"
                    class="menu-main-item-fixed"><?php echo MENU[7]; ?></a>
                <div>
                ...
                <div class="menu-grid-item item-1" data-direction="bt">
                    <div class="menu-grid-item-inner">
                        ...
                        <div class="menu-grid-main">
                            ...
                            <a href="<?php echo $path; ?><?php echo $idioma; ?>/port-experience"
                                class="menu-grid-main-item menu-item"><?php echo MENU[8]; ?></a>
                            <a href="<?php echo $path; ?><?php echo $idioma; ?>/discover-beyond"
                                class="menu-grid-main-item menu-item"><?php echo MENU[9]; ?></a>
                            <a href="<?php echo $path; ?><?php echo $idioma; ?>/map"
                            ...
                            <a href="<?php echo $path; ?><?php echo $idioma; ?>/contact"
                                class="menu-grid-main-item menu-item"><?php echo MENU[7]; ?></a>
                            <div class="language">
                                <?php $_lang = explode('.', $page) ?>
                        ...
                        <div class="menu-grid-minor text-white ">
                            <div class="m-4">
                                ...
                                <a href="mailto:info@porttainobay.com"
                                    class="text-white cursor-pointer link text-sm">info@porttainobay.com</a>
