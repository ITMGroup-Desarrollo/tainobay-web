                        ...
                        <div class="row">
                            ...
                            <div class="col-11 col-md-2 col-lg-1 single-blog-icon">
                                <div class="container-btn azulBlog">
                                    <div class="redes">
                                        <a target="_blank" class="bg-orange" href="https://www.facebook.com/sharer/sharer.php?u=https://localhost/tainobay/es/blog/${post.title}">
                                            <i class="icon fab fa-facebook-f"></i>
                                        </a>
                                        <a target="_blank" class="bg-orange" href="https://twitter.com/intent/tweet?url=https://localhost/tainobay/es/blog/${post.title}">
                                        ...
                                        <a target="_blank" class="bg-orange" href="https://api.whatsapp.com/send?text=https://localhost/tainobay/es/blog/${post.title}">
