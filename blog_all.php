                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-2 col-lg-3 blog-icons">
                            <div class="icons" style="display: flex;">
                                <svg class="list-icon link" xmlns="http://www.w3.org/2000/svg" width="100%"
                                ...
                                <svg class="grid-icon link" xmlns="http://www.w3.org/2000/svg" width="100%"
                                    height="100%" viewBox="0 0 512 512">
                                    <path fill=""
                ...
                <div class="pagination">
                    <div class="pagination-container">
                        <div id="prev-page" style="width:1rem; height: 1rem;">
                            <svg id="prev-page" src="assets/icons/icon_arrows_blue_left.svg" alt="Prev"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="1rem" height="1rem"
                        ...
                        <div id="next-page" style="width:1rem; height: 1rem;">
                            <svg id="next-page" src="assets/icons/icon_arrows_blue_right.svg" alt="Prev"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="1rem" height="1rem"
                                viewBox="0 0 231.26 729.5">
                                <path class="cls-1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-11 col-md-2 col-lg-1 single-blog-icon">
                                <div class="container-btn azulBlog">
                                    <div class="redes">
                                        <a target="_self" class="bg-orange" aria-label="Compartir en Facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $path; ?>es/blog/${post.title}">
                                            <i class="icon fab fa-facebook-f"></i>
                                        </a>
                                       <a target="_self" class="bg-orange" aria-label="Compartir en Twitter" href="https://twitter.com/intent/tweet?url=<?php echo $path; ?>es/blog/${post.title}">
                                        ...
                                        <a target="_self" class="bg-orange" aria-label="Compartir en WhatsApp" href="https://api.whatsapp.com/send?text=<?php echo $path; ?>es/blog/${post.title}">
                                   ...
                                   <button class="border-0 text-blue bg-transparent toggle-share" aria-label="Compartir">
