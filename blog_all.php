                ...
                $('#blog-container .posts-wrapper').append(`
                    <div class="container list-container">
                        <div class="row">
                            ...
                            <div class="col-11 col-md-2 col-lg-1 single-blog-icon button-share">
...
<script>
    $(document).on('click', '.toggle-share', function() {
        ...
        const isVisible = $shareContainer.css('display') === 'block';
        $('.redes').hide(); // Ocultamos todos los contenedores
        ...
        $('.toggle-share').removeClass('active'); // Quitamos la clase activa de todos los botones
        if (!isVisible) {
            $button.addClass('active'); // Añadimos la clase activa al botón clicado
        }
    });
</script>
