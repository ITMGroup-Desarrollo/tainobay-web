...
<body class="shock-body">
    ...
    <main id="faq-page" class="shock-main">
        ...
        <!-- Title -->
        <section class="shock-section has-holder pb-2 pe-5 ps-5" data-aos="fade-down" data-aos-delay="200"
                        ...
                        <div class="collapse-group mb-0 d-flex">
                            ...
                            <div class="w-100 content-faq">
                                <a href="#collapse-<?= $index ?>"
                                    class="collapse-toggle parent collapsed justify-content-between button-plus collapsed m-0 py-3"
                                    aria-expanded="false" aria-controls="collapse-<?= $index ?>" data-bs-toggle="collapse"
                                    aria-label="Ver más sobre <?= $faq['title'] ?>">
                                    <!-- Title -->
