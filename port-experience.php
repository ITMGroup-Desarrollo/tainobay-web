    ...
    <section class="shock-section pt-2 pb-4">
      <div class="container text-center my-5">
        <div class="mx-auto mb-2">
          <h2 class="text-style-3 lh-1 text-uppercase text-blue"><?= TITULOS_PORT_EXPERIENCE[0] ?><br>
      ...
      <div class="container max-w-85">
        <div class="container text-center">
          <div class="row row-cols-3 g-3">
            ...
            <div class="col">
              <div class="card shadow w-100 position-relative rounded-lg overflow-hidden">
                <a href="/admin/progress/1">
                  <img src="path_to_image.jpg" class="card-img brightness-75" alt="banner brand name">
                  <div class="card-img-overlay text-center text-white bg-primary w-100 px-5 py-2 position-absolute bottom-0">
                    <img src="path_to_logo.jpg" alt="Logo brand name" class="h-14 py-1 object-contain mx-auto">
                    <div class="transition-container max-h-0 py-3 overflow-hidden text-xs mx-auto rounded-lg d-flex justify-content-center align-items-center opacity-0">
                      <span class="mr-2">Ver actualizaciones</span>
                      <!-- Omit SVG -->
                    </div>
                  </div>
                </a>
