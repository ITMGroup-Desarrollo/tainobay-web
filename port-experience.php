    ...
    <section class="shock-section has-overlay">
      <div class="banner d-flex align-items-center">
        ...
        <div class="image-wrapper">
          ...
          <img src="assets/images/media/bg-port-experience.webp" class="image banner-fixed fit-cover brightness-8"
            alt="Banner port experience." />
    ...
    <section class="shock-section pt-2 pb-4" data-aos="fade-down" data-aos-delay="200" data-aos-duration="800">
      <div class="container text-center my-5">
        <div class="mx-auto mb-2">
          <h2 class="text-style-2 lh-1 text-uppercase gradient-animated-title animation-duration-2">
            <?= TITULOS_PORT_EXPERIENCE[0] ?><br>
    ...
    <section class="shock-section pb-5" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">
      <div class="container max-w-85">
                ...
                <div class="card-port text-bg-dark">
                  ...
                  <div class="card-img-wrapper">
                    <a href="<?= $idioma ?>/port-experience/<?= $point["path"]; ?>">
                      <img src="assets/images/port-experience/<?= $point['cover'] ?>" class="card-img brightness-9"
                        alt="Cover <?= $point['name'] ?>" loading="lazy">
                    </a>
                  </div>
                    ...
                    <div class="w-100 wrapper-link-more">
                      ...
                      <div class="mt-5px">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 286.26" width="130" fill="white">
                          ...
                          <path
                            d="M97.11,123.96c1.77,0,3.54-.32,5.26-.96,4.1-1.53,7.21-4.72,8.53-8.77.48-1.47.71-2.81.71-4.1,0-.24-.03-.46-.06-.72-.4-7.26-6.43-12.88-13.88-13.08l-.57-.04c-4.12,0-8.08,1.72-10.85,4.72-2.36,2.55-3.66,5.79-3.66,9.12,0,.93.13,1.77.25,2.39,1.22,6.63,7.21,11.45,14.26,11.45Z" />
                          <path
                            d="M196.41,121.78h0c2.35,1.43,5.03,2.18,7.76,2.18,8,0,14.51-6.21,14.51-13.84,0-.27-.03-.52-.08-.87-.27-4.08-2.39-7.81-5.82-10.23-4.27-3.02-9.88-3.61-14.81-1.38-3.15,1.43-5.66,3.88-7.05,6.89-.83,1.78-1.25,3.66-1.25,5.59,0,.53.07,1.05.18,1.85.57,4.05,2.96,7.63,6.56,9.81Z" />
                          <path
                            d="M159.78,187.71c-1.07-.85-2.15-1.51-3.29-2h0c-3.91-1.69-8.26-1.65-12.2.15-1.14.52-2.23,1.2-3.24,2.04-3.2,2.65-5.03,6.44-5.03,10.41,0,1.58.32,3.2.94,4.82,1.35,3.44,4.12,6.28,7.61,7.79.69.3,1.41.48,2.13.67,1.25.34,2.52.57,3.82.57.93,0,1.86-.11,2.78-.28,1.18-.23,2.34-.59,3.47-1.1,3.46-1.59,6.16-4.49,7.42-7.97.56-1.56.83-3.03.83-4.49,0-4.08-1.92-7.94-5.26-10.6Z" />
                        </svg>
                      </div>
                    </div>
                  </div>
        ...
        <div class="text-center d-block mt-4">
          <a href="<?= $idioma ?>/map"
            class="d-inline-block text-uppercase button-transparent button-orange text-center"><strong><?= TEXT_BUTTON_PORT_EXPERIENCE ?></strong></a>
        </div>
      </div>
    </section>
