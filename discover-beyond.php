                                ...
                                <div class="carousel-image-wrapper position-relative">
                                    ...
                                    <div class="slide-share position-absolute top-0 end-0 p-1 button-share">
                                        <div class="container-btn">
                                            <div class="redes">
                                                <a target="_blank" class="bg-orange" href="https://www.facebook.com/sharer/sharer.php?u=http://10.11.190.36/es/discover-beyond?post_id=${section.id}">
                                                    <i class="icon fab fa-facebook-f"></i>
                                                </a>
                                                <a target="_blank" class="bg-orange" href="https://twitter.com/intent/tweet?url=http://10.11.190.36/es/discover-beyond?post_id=${section.id}">
                                                ...
                                                <a target="_blank" class="bg-orange" href="https://api.whatsapp.com/send?text=http://10.11.190.36/es/discover-beyond?post_id=${section.id}">
