...
<body class="shock-body">
    ...
    <main id="main" class="shock-main">
        ...
        <section class="shock-section pt-2 pb-4" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
            <div class="container text-center my-5">
                <div class="container-title mx-auto mb-2">
                    <h2 class="text-style-2 lh-1 text-uppercase gradient-animated-title animation-duration-1"><span
                            class="d-block text-md-start"><?= HOME_TEXT_WELCOME[0] ?></span>
        ...
        <section class="shock-section pt-2 pb-4">
            <div class="scrolling-text">
                ...
                <div class="text-wrapper mix-blend-lighter">
                    <h2 class=" text-style-1 text-outline text-blue text-uppercase mb-0 text-center"
                        style="line-height: 75px;" data-lax="h-left">
        ...
        <!-- FAQ's -->
        <section class="shock-section pt-2 pb-4 mb-5" data-aos="zoom-in-up" data-aos-duration="400"
            data-aos-delay="300">
            <div class="container">
                <div class="text-center mb-5">
                    <h2 class="mb-0 text-blue text-style-2 gradient-animated-title animation-duration-3"
                        style="line-height: 70px;"><?= FAQS_TEXT[0] ?></h2>
                    <h3 class="mb-0 text-blue text-style-5 gradient-animated-title animation-duration-3">
                        <?= FAQS_TEXT[1] ?>
                    </h3>
                ...
                <div class="text-center">
                    <a href="<?= $idioma ?>/faqs"
                        class="text-uppercase button-transparent button-orange text-center"><strong><?= FAQS_TEXT[3]; ?></strong></a>
                </div>
            </div>
        </section>
